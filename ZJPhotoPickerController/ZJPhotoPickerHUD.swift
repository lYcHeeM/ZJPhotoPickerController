...
open class ZJPhotoPickerHUD: UIToolbar {
    ...
    @discardableResult
    open class func show(message: String?, inView view: UIView? = nil, animated: Bool = true, needsIndicator: Bool = true, hideAfter interval: TimeInterval? = 1.2) -> ZJPhotoPickerHUD? {
        ...
        let hud = ZJPhotoPickerHUD(message: message)
